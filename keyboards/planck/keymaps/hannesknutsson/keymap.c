...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LOWER] = LAYOUT_planck_grid(
	    ...
	    _______, _______, _______, _______, _______, _______, _______, _______, SE_DOT, _______, _______, _______
	),
	...
	[_LOWER] = LAYOUT_planck_grid(
	    ...
	    MU_TOG , CK_TOGG, _______, _______, _______, _______, _______, _______, _______, _______ , _______, _______
	)
};

//Tells QMK what to do when both lower and raise is active at the same time (activates _BOTH).
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, _LOWER, _RAISE, _BOTH);
}

//Defines what keycodes should be ignored (not sent to computer) when in music mode.
//Returning false here lets the presses through even in music mode.
